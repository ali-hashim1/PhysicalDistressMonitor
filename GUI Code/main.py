...
class trainingMode(QMainWindow):
    ...
    def updateGUI(self):
        ...
        self.spo2.setText(str((liveData[1])))
        self.gsr.setText(str(liveData[2]))
        self.temp.setText(str(liveData[3]))
        self.recorded.loc[len(self.recorded.index)] = [(liveData[0] / 300), (liveData[3] / 116), (liveData[1] / 100),
                                                       (liveData[2] / 512), 0]
...
class liveMode(QMainWindow):
    ...
    def updateGUI(self):
        ...
        test_data = np.array([[[(liveData[0]/300), (liveData[3]/116), (liveData[1]/100), (liveData[2]/512)]]])
